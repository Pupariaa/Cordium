...
class DiscordAnalytics {
    ...
    async init() {
        (0, node_fetch_1.default)(`${types_1.ApiEndpoints.BASE_URL}${types_1.ApiEndpoints.EDIT_SETTINGS_URL.replace(':id', this._client.user.id)}`, {
            ...
            setInterval(async () => {
                ...
                let userCount = this._client.guilds.reduce((a, g) => a + g.memberCount, 0);
    ...
    async trackInteractions(interaction) {
        ...
        if (interaction.type === 2)
            ...
            this.statsData.interactions.find((x) => x.name === interaction.data.custom_id && x.type === interaction.type) ?
